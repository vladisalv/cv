...
\iflangRussian{
  ...
  \newfontfamily\russianfont[Script=Cyrillic]{\myfont}
}
      ...
      \EngRus{{Development of Linux driver (zfcp) for IBM z System (s390x) storage hardware.}}
        ...
        \begin{adjustwidth}{0.5cm}{0cm}
          \begin{itemize}
            ...
            \item \EngRus{Work in international team. Regular code review.}
...
\iflangRussian{
  \cventry
    ...
    {}
    {
      \EngRus{Design and development of parallel version of algorithm search
              of repeats in biological sequence.}
...
\cventry
  {11.2013 -- 10.2014}
  {\EngRus{Technician}{Техник-программист}}
  {\EngRus{Nuclear Safety Institute}{ИБРАЭ РАН}}
  {\EngRus{Moscow}{Москва}}
  {}
  {
    \EngRus{{\ifcompact{\itshape}Development of model of hydrodynamic process in liquids using CABARET scheme.}}
    ...
    \ifdetailed{
      ...
      \begin{adjustwidth}{0.5cm}{0cm}
        \begin{itemize}
          ...
          \item \EngRus{Configure development environment.}
                       {Конфигурирование и поддержка среды разработки.}
          \item \EngRus{Implementation of new features in main project code (Fortran).}
                       {Реализация и добавление новой функциональности в основной код проекта (Fortran).}
          \item \EngRus{Training team basic of *nix and features of HPC software development.}
  ...
  {\ifdetailed{
     ...
     \begin{adjustwidth}{0.5cm}{0cm}
       \begin{itemize}
         ...
         \item \EngRus{Master dissertation "Research and development of parallel
         ...
         \iflangEnglish{% @PLAN: remove
         \item \EngRus{Knowledges: Computer architecture and assembler language,
...
\bibitem{ISP}
  \EngRus{{\itshape A.N. Pankratov, R.K. Tetuev, M.I. Pyatkov, V.P. Toigildin, N.N. Popova}
         ...
         {\ifcompact{\small}{\itshape Панкратов А.Н., Тетуев Р.К., Пятков М.И., Тойгильдин В.П., Попова Н.Н.}% @PLAN: remove \small
...
\ifdetailed{
  ...
  \cventry
    ...
    {\EngRus{Moscow}{Москва}}
    {}
    {\EngRus{\normalsize \href{http://ccoe.msu.ru/ru/node/64}{\textcolor{blue}{\underline{Won a fellowship}}}
  ...
  \cvline
    ...
    {\EngRus{Parallel program for recognition of extended inexact repeats in~genome.
             MPI+CUDA model is used for scalability on heterogeneous computer system.}
